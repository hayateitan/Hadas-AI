  ...
  return (
    <div id="principalContainerHome">
      <div id="homeimg1">
        ...
        <div id="ppHome1">
          <p id="Pp1">
            Learn how to make the most out of your data using Haroé.
          </p>
        </div>
        <div id="Dbuttonp1">
      ...
      <div id="homeimg3">
        ...
        <div id="ppHome3">
          <p id="Pp3">
            Get the latest updates on your team's work and collaborations to
            your projects.
          </p>
        </div>
        <div id="Dbuttonp3">
      ...
      <div id="homeimg6">
        ...
        <div id="ppHome6">
          <p id="Pp6">
            E.g., a link to a tutorial on the causal features of Haroé.
          </p>
        </div>
        <div id="Dbuttonp6">
      ...
      <div id="homeimg7">
        ...
        <div id="ppHome7">
          <p id="Pp7">
            Learn how to create an AI-based pricing policy using Haroé.
          </p>
        </div>
        <div id="Dbuttonp7">
